...
function MenuItem({type, price, qty, id, updateQty}) {
    ...
    return(
        <div className="MenuItem">
            ...
            {/* Using a Ternary so the "removeSlice" function will NOT run when the qty is a zero (NOTE: "null" is used for the "else" in this Ternary so that nothing will happen if condition is false) */}
